...
- (void)viewDidLoad {
	...
	self.navigationItem.rightBarButtonItem = [[[UIBarButtonItem alloc] 
																						...
																						autorelease];
	self.navigationItem.rightBarButtonItem.enabled = [app isInternetAvailable] && ![UIApplication sharedApplication].networkActivityIndicatorVisible;
...
- (void)internetReachabilityChanged:(NSNotification *)note
{
	app = [note object];
	self.navigationItem.rightBarButtonItem.enabled = [app isInternetAvailable] && ![UIApplication sharedApplication].networkActivityIndicatorVisible;
	if ([app isInternetAvailable] && [[[self tabBarController] selectedViewController] isEqual:[self navigationController]]) 
		[self.channel reload];
}
