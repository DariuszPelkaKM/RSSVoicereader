...
public class RSSHandler extends DefaultHandler 
{
	...
	public void startElement(String namespaceURI, String localName,String qName, Attributes atts) throws SAXException
	{
		...
		if (localName.equals("description") || localName.equals("summary"))
		{
		...
		if (localName.equals("pubDate") || localName.equals("updated"))
		{
	...
	public void characters(char ch[], int start, int length)
	{
		...
		switch (currentstate)
		{
			case RSS_TITLE:
				...
				break;
			case RSS_LINK:
				if (theString == null || theString.equalsIgnoreCase("\n"))
					_item.setLink(link);
				else
